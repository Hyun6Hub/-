    ...
    <div className="signup">
      ...
      <div>
        ...
        <p>
          ...
          quidem dolores minus. Tenetur id quasi eaque itaque. Nisi
          reprehenderit error quasi aspernatur veritatis consequuntur ipsam
          molestias minima ratione magnam?
        </p>
      </div>
      <div>
        <h4>서비스 약관 동의</h4>
        <textarea>
          ...
          rerum, explicabo cum dicta ad consequatur aliquam asperiores soluta
          eum recusandae aliquid, unde neque libero vel voluptas quos cupiditate
          rem. A!
        </textarea>
        <div>
          <input
